-- Phase 1: Création du système RBAC complet pour ANSUT (CORRIGÉ v2)
...
-- 1.2 Supprimer et recréer la table ansut_roles
DROP TABLE IF EXISTS public.ansut_roles CASCADE;
CREATE TABLE public.ansut_roles (
...
-- 1.3 Supprimer et recréer la table permissions
...
-- 1.4 Supprimer et recréer la table role_default_permissions
...
-- 1.5 Supprimer et recréer la table user_permissions
...
-- 1.15 Création de la table application_workflow
DROP TABLE IF EXISTS public.application_workflow CASCADE;
