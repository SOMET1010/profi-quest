...
-- Phase: Sécurisation des données sensibles
...
-- Permettre aux utilisateurs non authentifiés de soumettre UNIQUEMENT (pas de lecture)
-- Note: La politique INSERT existante "Anyone can submit public application" reste inchangée
